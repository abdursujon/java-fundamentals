 ...
 * one thread pauses until another signals that a required condition is now true.
 *
 * Without this, a waiting thread would have to loop and burn CPU checking a condition
 * (busy-waiting). wait() releases the lock and sleeps until notify() wakes it, so threads
 * hand off work efficiently. Classic use: producer-consumer.
 *
